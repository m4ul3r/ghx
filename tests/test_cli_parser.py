...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["function", "list", "--include-externals"],
        ["function", "list", "--include-externals", "--count"],
        ["function", "search", "main"],
        ["function", "search", "memcpy", "--include-externals"],
        ...
        ["il", "main", "--raw"],
        ["il", "main", "--form", "high", "--raw"],
        ["il", "main", "--form", "high", "--indirect"],
        ["disasm", "main"],
        ...
        ["strings", "--count"],
        ["strings", "--include-metadata"],
        ["strings", "--include-metadata", "--count"],
        ...
        ["comment", "list"],
        ["comment", "list", "--query", "TODO"],
        ["comment", "list", "--kinds", "pre,eol", "--query", "key"],
        ["proto", "get", "main"],
        ...
        ["read", "--address", "0x401000", "--encoding", "bytes"],
        ["read", "0x401000", "--encoding", "hex"],
        ...
        ["evidence", "xrefs", "main", "--limit", "25", "--offset", "5"],
        ["evidence", "function", "main"],
        ["evidence", "function", "main", "--context", "2"],
        ["evidence", "init"],
        ["evidence", "init", "--limit", "10"],
        ["evidence", "table", "0x401000"],
        ["evidence", "table", "vtable", "-n", "32", "--no-stop"],
        ["evidence", "table", "0x401000", "--entries", "64", "--stride", "8"],
        ["evidence", "message"],
        ...
        ["taint", "forward", "--interprocedural"],
        ["taint", "forward", "--interprocedural", "--ip-depth", "5"],
